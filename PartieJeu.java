...
public class PartieJeu {
    ...
    /** 
     * Permet de sauvegarder une partie à n'importe quel moment
     */
    ...
    public Pion[] pionsPossibles(Joueur joueur) {
        ...
        for (int indiceParcours = 0 ;
             indiceParcours < pionJeu.length && pionJeu[indiceParcours] != null ;
             indiceParcours++) {
            
            if (joueur.getEstRenard() == pionJeu[indiceParcours].getEstRenard()) {
