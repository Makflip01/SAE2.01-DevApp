...
import application.ControlerPlateauJeu;
/**
...
public class Main extends Application {
        ...
        private static FXMLLoader chargeurFXMLOptionPartie;
        
        private static FXMLLoader chargeurFXMLPartie;
	...
	public static void activerPartie() {
		fenetrePrincipale.setScene(scenePartie);
	        ...
	        ControlerOptionPartie controleurOption
	        = chargeurFXMLOptionPartie.getController();
	        
	        ControlerPlateauJeu controleurPartie
	        = chargeurFXMLPartie.getController();
	         
	        controleurPartie
	            .initData(controleurOption.pseudo1.getText(),
	                controleurOption.pseudo2.getText(),
	                controleurOption.choiceBoxDifficulte
	                    .getValue().equals("+2 oies"));
	}
	...
	public void start(Stage primaryStage) {
		try {
			 ...
			 * création de la scène associée à cette vue
			 */
			chargeurFXMLOptionPartie = new FXMLLoader();
			 ...
			 * création de la scène associée à cette vue
			 */
			chargeurFXMLPartie = new FXMLLoader();
