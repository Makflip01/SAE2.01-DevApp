...
public class Pion {
    ...
    public int[][] deplacementsPossibles() {
        ...
        if (getEstRenard()) {
            ...
            //si renard mange oie
            resultat[8] = new int[] {x - 2, y - 2};
            resultat[9] = new int[] {x, y - 2};
            resultat[10] = new int[] {x + 2, y - 2};
            resultat[11] = new int[] {x - 2, y + 2};
            resultat[12] = new int[] {x + 2, y + 2};
            resultat[13] = new int[] {x + 2, y};
            resultat[14] = new int[] {x - 2, y};
            resultat[15] = new int[] {x, y + 2};
        } else {
    ...
    @Override
    public boolean equals(Object deuxiemePion) {
        
        return deuxiemePion instanceof Pion && compareTo((Pion) deuxiemePion);
    }
     ...
     * @return
     */
    private boolean compareTo(Pion deuxiemePion) {

        return getAbscisse() == deuxiemePion.getAbscisse()
               && getOrdonnee() == deuxiemePion.getOrdonnee()
               && getEstRenard() == deuxiemePion.getEstRenard();
    }
