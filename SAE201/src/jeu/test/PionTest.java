...
class PionTest {
    ...
    void testGetCoordonneeX() {
        assertEquals(new Pion(true, 1, 3).getAbscisse(), 1);
        assertEquals(new Pion(false, 12, 43).getAbscisse(), 12);
        assertEquals(new Pion(true, 0, 1).getAbscisse(), 0);
    }
    ...
    void testDeplacement() {
        ...
        assertThrows(IllegalArgumentException.class,
                     ()-> new Pion(true, 4, 4).deplacement(0, 0));
        assertThrows(IllegalArgumentException.class,
